  ...
  return (
    <>
      <section className="footer-CTA">
        <img
          src="/assets/bg-tablet-pattern-darker.svg"
          alt="tablet pattern"
        ...
        />
        <h6> Simplify how your team works today.</h6>
      ...
      <section className="footer-links">
        ...
        <img src="/assets/logo-white.svg" alt="logo" className="footer-logo" />
        <small>Copyright 2020. All Rights Reserved</small>
        <small id="acknowledgement">Challenge by <a href="https://www.frontendmentor.io/home">Frontend Mentor</a>. Coded by <a href="https://github.com/DavidOG03/">David_OG</a></small>
      </section>
    </>
  );
}
